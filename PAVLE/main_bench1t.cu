...
void runVLCTest(char *file_name, uint num_block_threads, uint num_blocks) {
	...
	unsigned int num_ints = refbytesize/4 + ((refbytesize%4 ==0)?0:1);
		strcpy(kname, "cpu");
		sprintf(gname, "graph_t_ds_e%s", file_name+strlen(file_name)-4);
		LogStats2(gname, kname, ktime, (float)mem_size/1048576.0f, "Time", "ms", "Data size", "MB", "log", "log", 0);
		sprintf(gname, "graph_t_e_ds%05.2f", (float)mem_size/1048576.0f);
		LogStats2(gname, kname, ktime, H, "Time", "ms", "Entropy", "bits/byte", "log", "log", 0);
	//////////////////* END CPU *///////////////////////////////////
	...
	printf("GPU Encoding time (GM32): %f (ms)\n", ktime);
		strcpy(kname, "gm32");
		sprintf(gname, "graph_t_ds_e%s", file_name+strlen(file_name)-4);
		LogStats2(gname, kname, ktime, (float)mem_size/1048576.0f, "Time", "ms", "Data size", "MB", "log", "log", 1);
		//sprintf(gname, "graph_t_e_ds%05.2f", (float)mem_size/1048576.0f);
		//LogStats2(gname, kname, ktime, H, "Time", "ms", "Entropy", "bits/byte", "log", "log", 1);
	//////////////////* END KERNEL *///////////////////////////////////
#endif
	...
	printf("GPU Encoding time (SM32): %f (ms)\n", ktime/NT);
		strcpy(kname, "sm32");
		sprintf(gname, "graph_t_ds_e%s", file_name+strlen(file_name)-4);
		LogStats2(gname, kname, ktime/NT, (float)mem_size/1048576.0f, "Time", "ms", "Data size", "MB", "log", "log", 2);
		//sprintf(gname, "graph_t_e_ds%05.2f", (float)mem_size/1048576.0f);
		//LogStats2(gname, kname, ktime/NT, H, "Time", "ms", "Entropy", "bits/byte", "log", "log", 2);
	//////////////////* END KERNEL *///////////////////////////////////
#endif
	...
	printf("GPU Encoding time (SM64HUFF): %f (ms)\n", ktime/NT);
		...
		sprintf(gname, "graph_t_ds_e%s", file_name+strlen(file_name)-4);
		LogStats2(gname, kname, ktime/NT, (float)mem_size/1048576.0f, "Time", "ms", "Data size", "MB", "log", "log", 3);
		//sprintf(gname, "graph_t_e_ds%05.2f", (float)mem_size/1048576.0f);
		//LogStats2(gname, kname, ktime/NT, H, "Time", "ms", "Entropy", "bits/byte", "log", "log", 3);
	//////////////////* END KERNEL *///////////////////////////////////
#endif
	...
	printf("GPU Encoding time (SCAN1): %f (ms)\n", ktime/NT);
		strcpy(kname, "scan1");
		sprintf(gname, "graph_t_ds_e%s", file_name+strlen(file_name)-4);
		LogStats2(gname, kname, ktime/NT, (float)mem_size/1048576.0f, "Time", "ms", "Data size", "MB", "log", "log", 4);
		//sprintf(gname, "graph_t_e_ds%05.2f", (float)mem_size/1048576.0f);
		//LogStats2(gname, kname, ktime/NT, H, "Time", "ms", "Entropy", "bits/byte", "log", "log", 4);
	//////////////////* END KERNEL *///////////////////////////////////
#endif
	...
	printf("GPU Encoding time (DPTT): %f (ms)\n", ktime/NT);
		...
		sprintf(gname, "graph_t_ds_e%s", file_name+strlen(file_name)-4);
		LogStats2(gname, kname, ktime/NT, (float)mem_size/1048576.0f, "Time", "ms", "Data size", "MB", "lin", "lin", 6);
		//sprintf(gname, "e_ds%05.2f", (float)mem_size/1048576.0f);
		//LogStats2(gname, kname, ktime/NT, H, "Time", "ms", "Entropy", "bits/byte", "lin", "lin", 6);
	}
	//////////////////* END KERNEL *///////////////////////////////////
#endif
	...
	printf("GPU Encoding time (SCAN2): %f (ms)\n", ktime/NT);
		...
		LogStats2(gname, kname, ktime/NT, (float)mem_size/1048576.0f, "Time", "ms", "Data size", "MB", "lin", "lin", 7);
		sprintf(gname, "e_ds%05.2f", (float)mem_size/1048576.0f);
		LogStats2(gname, kname, ktime/NT, H, "Time", "ms", "Entropy", "bits/byte", "lin", "lin", 7);
	//////////////////* END KERNEL *///////////////////////////////////
#endif
